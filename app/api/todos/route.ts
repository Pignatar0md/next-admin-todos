...
export async function GET(request: NextRequest) {
  ...
  const take = Number(params.searchParams.get("take")) !== 0 ? Number(params.searchParams.get("take")) : 10
  const skip = Number(params.searchParams.get("skip")) !== 0 ? Number(params.searchParams.get("skip")) : 0
